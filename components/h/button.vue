    ...
    <button
      ...
      :class="[
        props.gradient && !props.outlined
          ...
          : '',
        props.isLoading || disabled ? 'cursor-default' : 'cursor-pointer',
        props.outlined
          ? props.outlinedClass
            ? props.outlinedClass
      ...
      class="h-8 w-full ring-2 ring-transparent hover:ring-primary hover:ring-opacity-50 shadow-current font-semibold focus:outline-none focus:shadow-outline transition-all duration-300 ease-in-out"
    >
      <div

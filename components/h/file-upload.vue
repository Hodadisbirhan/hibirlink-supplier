...
const file = ref(
  (value.value as Array<FileInterface>) || new Array<FileInterface>()
);
...
<template>
  <h-drag-and-drop
    :class="props.class"
    class="min-h-[13rem] relative py-2 border-dashed border-[3px] rounded-md border-neutral500 hover:border-primaryvar2"
  >
